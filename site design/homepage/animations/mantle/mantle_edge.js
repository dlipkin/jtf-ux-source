...
"stage": {
    ...
    states: {
        "Base State": {
            ...
            "${_Stage}": [
                ["color", "background-color", 'rgba(44,144,165,1.00)'],
                ["style", "width", '700px'],
                ["style", "height", '400px'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid342", tween: [ "style", "${_mantle-computer}", "-moz-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 3667, duration: 0, easing: "easeOutQuad" },
                { id: "eid343", tween: [ "style", "${_mantle-computer}", "-ms-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 3667, duration: 0, easing: "easeOutQuad" },
                { id: "eid344", tween: [ "style", "${_mantle-computer}", "msTransformOrigin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 3667, duration: 0, easing: "easeOutQuad" },
                { id: "eid345", tween: [ "style", "${_mantle-computer}", "-o-transform-origin", [50,50], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,50]}], position: 3667, duration: 0, easing: "easeOutQuad" },
